        ...
        <>
            <section className="home" >
                <div className="container-fuild px-5">
                    <div className="row">
                        <div className="col-12 d-flex flex-wrap justify-content-between pt-3">
                            <div className="col-lg-6 mt-5 pt-5 ">
                                <h3 className="mt-5 pt-5 fs-1 fw-bold" style={{ color: "#0355cc" }} >Repair and <br /> Maintenance <br /> Services</h3>
                                <p style={{ fontSize: "0.8rem" }} className="my-4 " >Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui harum voluptatem adipisci. Quos molestiae saepe dicta nobis pariatur, tempora iusto, ad possimus soluta hic praesentium mollitia consequatur beatae, aspernatur culpa.</p>
                                <Link to={"contact"} className="button-orange px-5 py-1 fw-medium fs-4 text-decoration-none ">Contact Us</Link>
                            </div>
                            <div className="col-lg-6 col-12 pt-5 pt-lg-0  d-flex justify-content-lg-end justify-content-center align-items-end">
                                <img src={require("./image/slider-img.png")} height={"700vh"} alt="" className="col-lg-12 col-10" />
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <section className="about">
            ...
            {/*  */}
            <section className="home-service mt-5">
                <div className="container-fuild px-5">
                    <div className="row">
                        <div className="col-12  py-5 d-flex flex-wrap">
                            <div className="col-12 col-md-6 ">
                                <img src={require("./image/professional-img.png")} width={"100%"} alt="" className="col-11" />
                            </div>
                            <div className="col-12 col-md-6 home-service-box">
                            <h2 className="fw-semibold py-3" >WE PROVIDE PROFESSIONAL <br/> HOME SERVICES.</h2>
                            <p className="pb-3" >randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All randomised words which don't look even slightly</p>
                            <Link className="button-orange px-5 py-1 fw-medium fs-4 text-decoration-none ">READ MORE</Link> 
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="client">
                <div className="containet-fluid px-5">
                    <div className="row">
                        <div className="col-12">
                            <h2 className="text-center fw-semibold my-3"  >WHAT OUR CLIENTS SAY</h2>
                            <div className="col-12 mt-5 client-boxs d-flex justify-content-around">
                                <div className="col-lg-5 col-md-7 col-sm-8 col-12 client-box ">
                                    <div className="d-flex align-items-center">
                                    <img src={require("./image/client-1.jpg")} alt="" width={80} className="m-3" />
                                    <h6>Jorch Morik</h6>
                                    </div>
                    ...
                    <div className="row">
                        <div className="col-12 ">
                            ...
                            <div className="col-12 d-flex justify-content-between">
                                ...
                                <div className="col-6 d-flex justify-content-start my-4">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d501290.0349529937!2d76.96723499999999!3d11.013968899999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1738471781376!5m2!1sen!2sin" className="col-10" height="400" style={{ border: "0;" }} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
